...
public final class SettingsListener implements Listener {
	...
	public boolean isBlockTypeNecessaryPhysics(final Material material) {
		if (NECESSARY_PHYSICS_BLOCK_TYPES.isEmpty()) {
			...
			NECESSARY_PHYSICS_BLOCK_TYPES.addAll(MaterialTags.STAINED_GLASS_PANES.getValues());
	...
	public boolean isBlockTypeRedstonePhysics(final Material material) {
		if (REDSTONE_PHYSICS_BLOCK_TYPES.isEmpty()) {
			...
			REDSTONE_PHYSICS_BLOCK_TYPES.addAll(MaterialTags.REDSTONE_TORCH.getValues());
			...
			REDSTONE_PHYSICS_BLOCK_TYPES.addAll(MaterialTags.COMMAND_BLOCKS.getValues());
			...
			REDSTONE_PHYSICS_BLOCK_TYPES.addAll(MaterialTags.PISTONS.getValues());
